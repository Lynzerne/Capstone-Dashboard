...
for flow in flow_rows:
    ...
    # Temperature rules should remain standalone unless they explicitly mention a station
    if flow.get("rule_type") in temperature_rule_types and not flow_station_ids:
        combined_rows.append({
            ...
            "flow_min_exclusive": flow.get("flow_min_exclusive"),
            "flow_max_inclusive": flow.get("flow_max_inclusive"),
            "max_diversion_rate": flow.get("max_diversion_rate"),
...
if not df.empty:
    ...
    # Optional: nicer column order in Excel
    preferred_columns = [
        "rule_type",
        "condition_type",
        "season_type",
